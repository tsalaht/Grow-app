...
import { ArrowLeft, MoveHorizontal as MoreHorizontal, Save, Undo2, Redo2, Users, Bookmark, Star, Smile, Image, Mic, AlignLeft, Type, Clock } from 'lucide-react-native';
...
export default function CreateNoteScreen() {
  ...
  const pickImage = async () => {
    // طلب الإذن للوصول إلى مكتبة الصور
  ...
  // تحديث وظائف تغيير النص لحفظ التاريخ
